...
Leading development of AI-powered platform for manufacturing MEMS devices. Key research areas: using LLMs to formulate problems for formal methods; AI first compiler for manufacturing; building automated testing agents for numerical solution validation; automated NLP-driven programming of device-scale simulations.
