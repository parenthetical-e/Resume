...
Leading development of AI-powered platform for manufacturing advanced devices. Key research areas: using LLMs to formulate problems for formal methods; building automated testing agents for numerical solution validation; automated NLP-driven programming of device-scale simulations.
