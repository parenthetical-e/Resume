...
Co-lead scientific machine learning research program focused on closing the performance gap between academic results and industrial requirements. Lead development of Pasteur's scientific machine learning library and training pipeline (neural operators, graph neural networks, etc; $>$30 models). Lead development of Pasteur's causal analysis software for physical systems and time-series. Established “simulation intelligence” methods that use physics to do analog computations.
