...
GenAI research lead, AI platform for manufacturing custom MEMS devices. Key research areas: using LLMs to formulate problems for formal methods; building an AI-first compiler for manufacturing; developing automated testing agents for numerical solution validation and automated NLP-driven programming of device-scale simulations.

\vspace{-.25cm}
{\bf Phinyx} - Providence, RI\\
{\em Principal Scientist} \hfill {\bf 2024}\\
Head of research, automated programming for scientific computing. Rewrote core library for NLP program synthesis to make it work with any language. Did new research on chain-of-thought methods to scale Phinyx's technology to industry-scale simulations.
