...
I am an interdisciplinary scientist-engineer interested in high-impact, high-risk work bridging academic and industrial research. I have worked and published in scientific machine learning, computer science, causal analysis, chemistry, nanotechnology, and neuroscience.
% An interdisciplinary scientist-engineer who has worked and published in scientific machine learning, causal analysis, chemistry, nanotechnology, neuroscience, and reinforcement learning.
...
GenAI research lead, AI platform for manufacturing custom MEMS devices. Key research areas: using LLMs to formulate problems for formal methods; building an AI-first compiler for manufacturing; developing automated testing agents for numerical solution validation and automated LLM-driven programming of device-scale simulations.

\vspace{-.25cm}
{\bf Phinyx} - Providence, RI\\
{\em Principal Scientist} \hfill {\bf 2024}\\
Head of research, automated programming for scientific computing. Rewrote core library for LLM-driven program synthesis to make it work with any language. Did new research on chain-of-thought methods to scale Phinyx's technology to industry-scale simulations.
...
% ---------------------------------------------------------------------------
\vspace{-.8cm}
\section{\sc Programming} Production-ready software and ML models (JAX, PyTorch). Expert scientific programmer (Python). Fluent in development tools (Git, Docker, etc.).
...
\textsc{Total citations}: $>$4500. \textsc{h-index}: 15.
\\ 
\vspace{-.4cm} 
\\
